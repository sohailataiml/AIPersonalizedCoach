...
.PHONY: help setup dev dev-backend dev-frontend seed test lint typecheck build verify docker clean
...
help:
	...
	@echo "make verify  - tests + lint + typecheck + build + demo scenarios"
